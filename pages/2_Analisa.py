...
with tab2:
    with st.container():
        ...
        st.write('kamar tidur paling banyak 4')
        st.write('')
        st.write('')
        fig, ax = plt.subplots(figsize=(9,6))
...
with tab4:
        ...
        st.pyplot(fig)
        st.write("""
                mayoritas rumah memiliki luas bangunan di bawah 400 meter persegi dan
        ...
        st.write("""
                terdapat rumah dengan luas 600 meter persegi dengan harga 28 M
                walaupun ada bangunanya lebih luas 993 meter persegi dengan harga di bawahnya 15 M 
                """) 
        st.write('')
        st.write('')
        st.error("""Data Diambil Dengan Metode Web Scrapping Di Website [Lamudi](https://www.lamudi.co.id/)""")
...
with tab5:
        ...
        st.write("""
                lahan paling mahal seharga 28 M dengan luas 576 meter persegi
                tetapi ada yang lebih luas dengan harga dibawahnya 992 meter persegi dengan harga 20 M
                """)
        st.write('')
        st.write('')
        st.error("""Data Diambil Dengan Metode Web Scrapping Di Website [Lamudi](https://www.lamudi.co.id/)""")
...
with tab6:
    ...
    st.write('Rumah paling banyak dijual dibanding jenis lainya')
    st.write('')
    st.write('')
    ...
    st.write('Rumah kategori biasa yang paling banyak dijual')
    st.write('')
    st.write('')
    ...
    chart_1 = alt.Chart(lokasi_alamat_rata__).mark_bar().encode(
         ...
         title='Harga Rata-Rata Rumah Per Lokasi'
    ).interactive()
