...
def predict():
    with st.container():
        ...
        if st.button('Submit'):
            ...
            st.info('ini hanyalah prediksi dan tidak 100% tepat tergantung faktor lainya dan sesungguhnya prediksi yang tepat hanya milik tuhan semata ingatlah itu ki sanak')
            st.write('')
            st.write('')
